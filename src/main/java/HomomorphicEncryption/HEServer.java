...
//                    byte[] eciesPrivateKey = KG.readECIESPrivateKeyFromPemFile("ECIESprivate.pem");
//                    keywordFile.add(eciesManager.decryptCipherContract(cipherContract.cipher, eciesPrivateKey,cipherContract.IV));
//                    System.out.println(keywordFile.lastElement().toJSONString());
//                    System.out.println("일치하는 파일 발견!");
//                }
//            }
//
//        }
